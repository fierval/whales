...
model.add(Convolution2D(32, 3, 11, 11, border_mode='full', init='glorot_normal')) 
model.add(Activation('relu'))
#model.add(BatchNormalization((32, 390, 390)))
model.add(Convolution2D(32, 32, 9, 9))
model.add(Activation('relu'))
model.add(MaxPooling2D(poolsize=(2, 2)))
model.add(Dropout(0.25))

model.add(Convolution2D(56, 32, 7, 7, border_mode='full', init='glorot_normal')) 
model.add(Activation('relu'))
#model.add(BatchNormalization((64, 199, 199)))
model.add(Convolution2D(56, 56, 5, 5)) 
model.add(Activation('relu'))
model.add(MaxPooling2D(poolsize=(2, 2)))
model.add(Dropout(0.25))

model.add(Convolution2D(72, 56, 3, 3, border_mode='full', init='glorot_normal')) 
model.add(Activation('relu'))
#model.add(BatchNormalization((96, 69, 69)))
model.add(Convolution2D(72, 72, 3, 3)) 
model.add(Activation('relu'))
model.add(MaxPooling2D(poolsize=(2, 2)))
model.add(Dropout(0.25))

model.add(Convolution2D(96, 72, 3, 3, border_mode='full', init='glorot_normal')) 
model.add(Activation('relu'))
...
model.add(Convolution2D(156, 128, 3, 3, border_mode='full')) 
model.add(Activation('relu'))
#model.add(BatchNormalization((512, 12, 12)))
model.add(Convolution2D(156, 156, 3, 3)) 
model.add(Activation('relu'))
model.add(MaxPooling2D(poolsize=(2, 2)))
model.add(Dropout(0.25))

model.add(Convolution2D(192, 156, 3, 3, border_mode='full')) 
model.add(Activation('relu'))
model.add(BatchNormalization((192, 6, 6)))
...
open('/users/boris/dropbox/kaggle/whales/models/model_4.json', 'w').write(json_string)
model.save_weights('/users/boris/dropbox/kaggle/whales/models/weights_4.h5', overwrite=True)